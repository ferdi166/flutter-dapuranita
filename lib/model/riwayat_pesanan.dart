// file: lib/model/riwayat_pesanan.dart
import 'package:flutter/material.dart';

class RiwayatPesananResponse {
  bool? success;
  String? message;
  List<RiwayatPesananModel>? data;
  int? totalPesanan;

  RiwayatPesananResponse({
    this.success,
    this.message,
    this.data,
    this.totalPesanan,
  ...
  RiwayatPesananResponse.fromJson(Map<String, dynamic> json) {
    success = json['success'];
    message = json['message'];
    totalPesanan = json['total_pesanan'];
    if (json['data'] != null) {
      data = <RiwayatPesananModel>[];
      json['data'].forEach((v) {
        data!.add(RiwayatPesananModel.fromJson(v));
      });
    }
  }
}
...
class RiwayatPesananModel {
  ...
  RiwayatPesananModel.fromJson(Map<String, dynamic> json) {
    // Handle int fields
